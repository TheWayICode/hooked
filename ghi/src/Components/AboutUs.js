...
function AboutUs() {
  ...
  return (
    <>
      <LoggedNav />
      <div
        className="w-full bg-cover bg-no-repeat py-10 px-4 min-h-screen mt-[-80px]"
        style={{
      ...
      >
        <div className="max-w-[1240px] mx-auto pt-[80px]">
          <h1 className="md:text-8xl text-center font-bold text-white mb-16">
            Meet the Team
          </h1>
          <div className="max-w-[1240px] mx-auto grid md:grid-cols-4 gap-8 mb-24">
            <div className="bg-[#d6fbff] rounded-lg shadow-2xl p-6 flex flex-col items-center">
              ...
              <a
                href="https://gitlab.com/skoreancho"
                className="text-[#0000FF] text-xl"
              >
                Gitlab
              </a>
            </div>
            ...
            <div className="bg-[#d6fbff] rounded-lg shadow-2xl p-6 flex flex-col items-center">
              ...
              <a
                href="https://gitlab.com/robin_kim"
                className="text-[#0000FF] text-xl"
              >
                Gitlab
              </a>
            ...
            <div className="bg-[#d6fbff] rounded-lg shadow-2xl p-6 flex flex-col items-center">
              ...
              <a
                href="https://gitlab.com/MikeMieln"
                className="text-[#0000FF] text-xl"
              >
                Gitlab
              </a>
