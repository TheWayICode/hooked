      ...
      <div className="w-full bg-cover bg-white bg-no-repeat py-10 px-4">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-">
          <img
            ...
            src="https://cdn.pixabay.com/photo/2017/02/13/04/42/florida-2061777_960_720.jpg"
            alt="SMP"
            style={{ width: "100%" }}
          />
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow">
            <a
              href={`https://www.google.com/maps/dir/?api=1&destination=${24.752151191414374},${-81.42312722095829}`}
              className="mb-4"
            >
              Get directions
            </a>
