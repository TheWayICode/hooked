...
function Florida_Keys_Details() {
  ...
  const fishList = async () => {
    const fishUrl = `${process.env.REACT_APP_USER_SERVICE_API_HOST}/api/locations/8`;
    ...
    if (fishResponse.ok) {
      ...
      const map = new mapboxgl.Map({
        ...
        center: [-81.42312722095829, 24.752151191414374],
        zoom: 12
      });
    ...
    <>
      <div className="w-full bg-cover bg-white bg-no-repeat py-10 px-4">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-">
          <img className="w-full mx-auto my-4 mb-8 rounded-2xl" src="https://cdn.pixabay.com/photo/2017/02/13/04/42/florida-2061777_960_720.jpg" alt="SMP" style={{width:'100%'}}/>
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-8 mb-24">
              <div className="flex flex-col justify-center">
                <p className="text-[#000000] md:text-4xl font-bold mb-8">Florida Keys</p>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow">
            <a href={`https://www.google.com/maps/dir/?api=1&destination=${24.752151191414374},${-81.42312722095829}`} className="mb-4">Get directions</a>
          </button>
