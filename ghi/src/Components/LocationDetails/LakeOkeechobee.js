      ...
      <div className="w-full bg-cover bg-white bg-no-repeat py-10 px-4">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-">
          <img
            ...
            src="https://cdn.pixabay.com/photo/2019/08/21/02/18/lake-okeechobee-4419985_960_720.jpg"
            alt="SMP"
            style={{ width: "100%" }}
          />
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow">
            <a
              href={`https://www.google.com/maps/dir/?api=1&destination=${26.990875868550347},${-80.80259388849842}`}
              className="mb-4"
            >
              Get directions
            </a>
