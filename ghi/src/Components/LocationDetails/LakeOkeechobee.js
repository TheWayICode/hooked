...
function LakeOkeechobeeDetails() {
  ...
  const fishList = async () => {
    const fishUrl = `${process.env.REACT_APP_USER_SERVICE_API_HOST}/api/locations/7`;
    ...
    if (fishResponse.ok) {
      ...
      const map = new mapboxgl.Map({
        ...
        center: [-80.80259388849842, 26.990875868550347],
        zoom: 12,
      });
...
export default LakeOkeechobeeDetails;
