...
function Hudson_River_Details() {
  ...
  const fishList = async () => {
    const fishUrl = "http://localhost:8000/api/locations/4";
    ...
    if (fishResponse.ok) {
      ...
      const map = new mapboxgl.Map({
        ...
        center: [42.550187229084955, -73.79993546808437],
        zoom: 12
      });
      ...
      const marker = new mapboxgl.Marker()
        .setLngLat([42.550187229084955, -73.79993546808437])
        .addTo(map);
    ...
    <>
      <div className="w-full bg-cover bg-white bg-no-repeat py-10 px-4">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-">
          <img className="w-full mx-auto my-4 mb-8 rounded-2xl" src="https://cdn.pixabay.com/photo/2019/10/10/23/48/landscape-4540748_960_720.jpg" alt="SMP" style={{width:'100%'}}/>
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-8 mb-24">
              <div className="flex flex-col justify-center">
                <p className="text-[#000000] md:text-4xl font-bold mb-8">Hudson River</p>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow">
            <a href={`https://www.google.com/maps/dir/?api=1&destination=${42.550187229084955},${-73.79993546808437}`} className="mb-4">Get directions</a>
          </button>
...
export default Hudson_River_Details;
