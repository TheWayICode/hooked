  ...
  const fishList = async () => {
    ...
    if (fishResponse.ok) {
      ...
      const map = new mapboxgl.Map({
        ...
        center: [43.87849944804798, -70.572392332463],
        zoom: 12
      });
      ...
      const marker = new mapboxgl.Marker()
        .setLngLat([43.87849944804798, -70.572392332463])
        .addTo(map);
    ...
    <>
      <div className="w-full bg-cover bg-white bg-no-repeat py-10 px-4">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-">
          <img className="w-full mx-auto my-4 mb-8 rounded-2xl" src="https://cdn.pixabay.com/photo/2019/07/29/12/13/sun-4370513_960_720.jpg" alt="SMP" style={{width:'100%'}}/>
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-8 mb-24">
              <div className="flex flex-col justify-center">
                <p className="text-[#000000] md:text-4xl font-bold mb-8">Sebago Lake</p>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow">
            <a href={`https://www.google.com/maps/dir/?api=1&destination=${43.87849944804798},${-70.572392332463}`} className="mb-4">Get directions</a>
          </button>
