  ...
  const fishList = async () => {
    ...
    if (fishResponse.ok) {
      ...
      const map = new mapboxgl.Map({
        ...
        center: [30.451588319411332, -97.9149898743467],
        zoom: 12
      });
      ...
      const marker = new mapboxgl.Marker()
        .setLngLat([30.451588319411332, -97.9149898743467])
        .addTo(map);
    ...
    <>
      <div className="w-full bg-cover bg-white bg-no-repeat py-10 px-4">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-">
          <img className="w-full mx-auto my-4 mb-8 rounded-2xl" src="https://cdn.pixabay.com/photo/2016/11/17/21/55/scenic-1832828_960_720.jpg" alt="SMP" style={{width:'100%'}}/>
            <div className="max-w-[1240px] mx-auto grid md:grid-cols-2 gap-8 mb-24">
              <div className="flex flex-col justify-center">
                <p className="text-[#000000] md:text-4xl font-bold mb-8">Lake Travis</p>
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow">
            <a href={`https://www.google.com/maps/dir/?api=1&destination=${30.451588319411332},${-97.9149898743467}`} className="mb-4">Get directions</a>
          </button>
...
export default Lake_Travis_Details;
