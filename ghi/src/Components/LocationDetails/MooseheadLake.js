...
function MooseheadLakeDetails() {
  ...
  const fishList = async () => {
    const fishUrl = `${process.env.REACT_APP_USER_SERVICE_API_HOST}/api/locations/10`;
    ...
    <>
      ...
      <div className="w-full bg-cover bg-white bg-no-repeat py-10 px-4">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-">
          ...
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded shadow">
            <a
              href={`https://www.google.com/maps/dir/?api=1&destination=${45.67945022995479},${-69.65452913012051}`}
              className="mb-4"
            >
              Get directions
            </a>
...
export default MooseheadLakeDetails;
